...
namespace Capibutler.Editor.UI
{
    public class VoodooDebuggerWindow : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            root.styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>( PathUtils.PackagePath("Editor/UI/Voodoo.uss") ));
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(PathUtils.PackagePath("Editor/UI/VoodooDebugger.uxml"));
        ...
        [MenuItem("Capipocavara/Debug/Live VoodooVara Events", false, priority = 200)]
        private static void OpenEventWindow()
        {
            CreateWindow("debugEventsTab");
        }

        [MenuItem("Capipocavara/Debug/Live VoodooVara Values", false, priority = 201)]
