...
namespace Capybutler
{
    public static class LogButler
    {
        ...
        [Conditional("ENABLE_LOGGING")] public static void Info(object message) => Debug.Log(message);

        [Conditional("ENABLE_LOGGING")] public static void InfoFormat(string format, params object[] args) => Debug.LogFormat(format, args);

        [Conditional("ENABLE_LOGGING")] public static void LogInfo(this Object context, object message) => Debug.Log(message, context);

        [Conditional("ENABLE_LOGGING")] public static void LogInfoFormat(this Object context, string format, params object[] args) => Debug.LogFormat(format, args, context);

        [Conditional("ENABLE_LOGGING")] public static void Warning(object message) => Debug.LogWarning(message);

        [Conditional("ENABLE_LOGGING")] public static void WarningFormat(string format, params object[] args) => Debug.LogWarningFormat(format, args);

        [Conditional("ENABLE_LOGGING")] public static void LogWarning(this Object context, object message) => Debug.LogWarning(message, context);

        [Conditional("ENABLE_LOGGING")] public static void LogWarningFormat(this Object context, string format, params object[] args) => Debug.LogWarningFormat(format, args, context);

        [Conditional("ENABLE_LOGGING")] public static void Assert(object message) => Debug.LogAssertion(message);

        [Conditional("ENABLE_LOGGING")] public static void AssertFormat(string format, params object[] args) => Debug.LogAssertionFormat(format, args);

        [Conditional("ENABLE_LOGGING")] public static void LogAssert(this Object context, object message) => Debug.LogAssertion(message, context);

        [Conditional("ENABLE_LOGGING")] public static void LogAssertFormat(this Object context, string format, params object[] args) => Debug.LogAssertionFormat(format, args, context);
